        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            {isAdminPage ? (
              <button
                onClick={goToHome}
                className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-base font-medium transition-colors cursor-pointer"
              >
                Əsas Səhifə
              </button>
            ) : (
              <>
                <button
                  onClick={() => scrollToSection("netice-bolmesi")}
                  className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-base font-medium transition-colors cursor-pointer"
                >
                  Əsas səhifə
                </button>
                <button
                  onClick={() => scrollToSection("elaqe-melumatlari")}
                  className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-base font-medium transition-colors cursor-pointer"
                >
                  Əlaqə Məlumatları
                </button>
        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          >
            <div className="max-w-7xl mx-auto px-4 md:pl-12 py-6 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row md:space-y-0 md:space-x-6 space-y-3 text-left max-w-2xl mx-auto">
                <div className="flex items-center space-x-2">
                  ...
                  <a
                    href="mailto:imtahan@bilim.edu.az"
                    className="text-gray-600 hover:text-gray-900 transition-colors"
                  >
                    imtahan@bilim.edu.az
                  </a>
                </div>
